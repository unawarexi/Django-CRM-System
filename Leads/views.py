...
from .forms.lead_forms import LeadForm, LeadModelForm, CustomUserCreationForm, AssignAgentForm
...
class LeadListView(LoginRequiredMixin, generic.ListView):
    ...
    def get_queryset(self):
        ...
        if user.is_organisor:
            ...
            queryset = Leads.objects.filter(organisation = user.agent.organisation,  agent__isnull=False)
